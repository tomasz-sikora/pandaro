...
import type { Segment, SpeakerProfile, AsrEngine, AgentEvent } from '@pandaro/shared-types'
...
export function useAgentPipeline() {
  ...
  const process = useCallback(
    ...
    [settings, startSession, setAudio, setDuration, setProcessing, setTranscript,
     ...
     setAgentSessionId, setSegmentQuality, setTopics, setQuotesAndFacts,
     appendSegments, applyTranslations, applySpeakerLabels, addAgentEvent, navigate],
  )
